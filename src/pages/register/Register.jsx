          ...
          <div className="row d-flex">
            <div className="col-lg-6">
              <div className="card1 pb-5">
                <div className="row">
                  {" "}
                  <img src={Logo} className="logoLoginR" />{" "}
                </div>
            ...
            <div className="col-lg-6">
              <div style={{marginTop:'36px'}} className="card2  border-0 px-4 py-5">
                <div className="row mb-4 px-3">
                  ...
                  <div className="twitter text-center mr-3">
                    <a style={{color:'white'}} href="https://swapo-backend.herokuapp.com/google">                 <div className="fa fa-google">
