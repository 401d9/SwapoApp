          ...
          <div className="row d-flex">
            ...
            <div className="col-lg-6">
              <div className="card2  border-0 px-4 py-5">
                ...
                </label> <input className="mb-4 loginInput" type="email" name="email" placeholder="Enter a valid Email" required ref={email} /> </div>
                <div className="row px-3"> <label className="mb-1">
                ...
                </label> <input className="mb-4 loginInput" type="password" name="password" placeholder="Enter password"
                  required
                  minLength="6"
                  ref={password} /> </div>
                <div className="row px-3 last"> <label className="mb-1">
                  {/* <h6 className="mb-0 text-sm">Confirmed Password</h6> */}
                </label> <input className="loginInput" type="password" name="passwordAgain" placeholder="Confirmed Password "
                  required
                  minLength="6"
                ...
                <div className="row mb-3 px-3" ><Link to=''> <button type="submit" className="btn btn-blue text-center button-login" >Sign up</button></Link> </div>
